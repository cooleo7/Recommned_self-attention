...
from transformer_model6 import CustomDataset, logits_to_recs
from metrics import *
import argparse
...
def evaluate(args):
    ...
    #model = get_model(n_items, d_model, heads, 0,
    #                  n_layers, 64, weights_path, device)  # modi
...
def get_args():
    ...
    parser.add_argument('--data', type=str, default="data/data6.npz")  # modi
    parser.add_argument('--seq_len', type=int, default=16)
    parser.add_argument('--n_items', type=int, default=57,   # modi
                        help='number of different items that can be recommended')
    parser.add_argument('--d_model', type=int, default=70,   # modi
                        help='dimension of the model')
    parser.add_argument('--heads', type=int, default=2,      # modi
                        help='number of Transformer heads')
    parser.add_argument('--n_layers', type=int, default=2,  # modi
