...
from transformer_model3 import CustomDataset, logits_to_recs
from metrics import *
import argparse
...
def get_args():
    ...
    parser.add_argument('--data', type=str, default="data/data3.npz")  # modi
    parser.add_argument('--seq_len', type=int, default=16)
    parser.add_argument('--n_items', type=int, default=43,   # modi
                        help='number of different items that can be recommended')
    parser.add_argument('--d_model', type=int, default=56,   # modi
